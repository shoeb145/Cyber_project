...
import { Search, Filter, Grid, List, BookOpen, TrendingUp, Award, Clock } from 'lucide-react';
...
const Modules = () => {
  ...
  const inProgressModules = moduleData.filter(m => m.progress > 0 && m.progress < 100).length;
  const avgProgress = Math.round(moduleData.reduce((sum, m) => sum + m.progress, 0) / totalModules);
          ...
          <div className="mb-8 sm:mb-12">
            <div className="mb-6 sm:mb-8 text-center">
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
                Master cybersecurity through hands-on modules and interactive content
              </p>
            </div>
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4 justify-center text-center sm:justify-start sm:text-left">
                    ...
                    <div className="min-w-0">
                      <p className="text-xs sm:text-sm font-medium text-blue-700">Total Modules</p>
                      <p className="text-xl sm:text-2xl font-bold text-blue-900">{totalModules}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4 justify-center text-center sm:justify-start sm:text-left">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-green-900">{completedModules}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4 justify-center text-center sm:justify-start sm:text-left">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="text-xl sm:text-2xl font-bold text-yellow-900">{inProgressModules}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-4 sm:p-6">
                  <div className="flex items-center space-x-3 sm:space-x-4 justify-center text-center sm:justify-start sm:text-left">
                    ...
                    <div className="min-w-0">
                      <p className="text-xs sm:text-sm font-medium text-purple-700">Avg Progress</p>
                      <p className="text-xl sm:text-2xl font-bold text-purple-900">{avgProgress}%</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
            ...
            <CardHeader className="pb-4">
              <div className="flex flex-col space-y-4 lg:flex-row lg:justify-between lg:items-center lg:space-y-0">
                <div className="space-y-1">
                  <CardTitle className="text-lg sm:text-xl text-gray-900 text-left">Find Your Perfect Module</CardTitle>
                  <CardDescription className="text-sm sm:text-base text-gray-600 text-left">
                    Search and filter to discover modules that match your learning goals
                  </CardDescription>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <span className="hidden sm:inline tracking-wide">Grid View</span>
                  </Button>
                  <Button 
                  ...
                  >
                    ...
                    <span className="hidden sm:inline tracking-wide">List View</span>
                  </Button>
                </div>
              </div>
            </CardHeader>
            <CardContent className="pt-0">
              <div className="flex flex-col sm:flex-row gap-4 mb-6">
                ...
                >
                  ...
                  <span className="whitespace-nowrap tracking-wide">{showFilters ? 'Hide Filters' : 'Show Filters'}</span>
                </Button>
              </div>
                ...
                <div className="border-t border-gray-200 pt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    <div className="space-y-3">
                      <label className="text-sm font-bold text-gray-800 block tracking-wide">Category</label>
                      <Select value={categoryFilter} onValueChange={setCategoryFilter}>
                        <SelectTrigger className="w-full h-12 bg-white text-gray-900 font-bold border-2 border-gray-300 hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-lg shadow-sm transition-all">
                          <SelectValue placeholder="Select category" className="text-gray-900 font-bold" />
                        </SelectTrigger>
                        <SelectContent className="bg-white border-2 border-gray-200 shadow-lg rounded-lg p-1">
                          {['All', 'Offensive', 'Defensive', 'General'].map(category => (
                            <SelectItem key={category} value={category} className="text-gray-900 font-semibold hover:bg-blue-100 hover:text-blue-900 px-4 py-3 cursor-pointer rounded-md transition-colors data-[highlighted]:bg-blue-100 data-[highlighted]:text-blue-900">
                              {category}
                            </SelectItem>
                          ))}
                        </SelectContent>
                    ...
                    <div className="space-y-3">
                      <label className="text-sm font-bold text-gray-800 block tracking-wide">Difficulty</label>
                      <Select value={difficultyFilter} onValueChange={setDifficultyFilter}>
                        <SelectTrigger className="w-full h-12 bg-white text-gray-900 font-bold border-2 border-gray-300 hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-lg shadow-sm transition-all">
                          <SelectValue placeholder="Select difficulty" className="text-gray-900 font-bold" />
                        </SelectTrigger>
                        <SelectContent className="bg-white border-2 border-gray-200 shadow-lg rounded-lg p-1">
                          {['All', 'Fundamental', 'Easy', 'Medium', 'Hard'].map(difficulty => (
                            <SelectItem key={difficulty} value={difficulty} className="text-gray-900 font-semibold hover:bg-green-100 hover:text-green-900 px-4 py-3 cursor-pointer rounded-md transition-colors data-[highlighted]:bg-green-100 data-[highlighted]:text-green-900">
                              {difficulty}
                            </SelectItem>
                          ))}
                        </SelectContent>
                    ...
                    <div className="space-y-3">
                      <label className="text-sm font-bold text-gray-800 block tracking-wide">Progress</label>
                      <Select value={progressFilter} onValueChange={setProgressFilter}>
                        <SelectTrigger className="w-full h-12 bg-white text-gray-900 font-bold border-2 border-gray-300 hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-lg shadow-sm transition-all">
                          <SelectValue placeholder="Select progress" className="text-gray-900 font-bold" />
                        </SelectTrigger>
                        <SelectContent className="bg-white border-2 border-gray-200 shadow-lg rounded-lg p-1">
                          {['All', 'Not Started', 'In Progress', 'Completed'].map(progress => (
                            <SelectItem key={progress} value={progress} className="text-gray-900 font-semibold hover:bg-purple-100 hover:text-purple-900 px-4 py-3 cursor-pointer rounded-md transition-colors data-[highlighted]:bg-purple-100 data-[highlighted]:text-purple-900">
                              {progress}
                            </SelectItem>
                          ))}
                        </SelectContent>
                  ...
                  {/* Active Filters */}
                  {(categoryFilter !== 'All' || difficultyFilter !== 'All' || progressFilter !== 'All') && (
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-gray-200">
                      <span className="text-sm font-medium text-gray-700">Active filters:</span>
                      {categoryFilter !== 'All' && (
                        <Badge variant="secondary" className="flex items-center gap-2 bg-blue-50 text-blue-900 hover:bg-blue-100 border border-blue-200 px-3 py-1.5 font-medium shadow-sm">
                          <span className="font-semibold">Category:</span> {categoryFilter}
                          <Button 
                            variant="ghost" 
                            size="sm" 
                      ...
                      {difficultyFilter !== 'All' && (
                        <Badge variant="secondary" className="flex items-center gap-2 bg-green-50 text-green-900 hover:bg-green-100 border border-green-200 px-3 py-1.5 font-medium shadow-sm">
                      ...
                      {progressFilter !== 'All' && (
                        <Badge variant="secondary" className="flex items-center gap-2 bg-purple-50 text-purple-900 hover:bg-purple-100 border border-purple-200 px-3 py-1.5 font-medium shadow-sm">
                          <span className="font-semibold">Progress:</span> {progressFilter}
                          <Button 
                            variant="ghost" 
                            size="sm" 
          ...
          {filteredModules.length > 0 ? (
            <div className={`grid gap-4 sm:gap-6 ${
              ...
              {filteredModules.map(module => (
                <ModernModuleCard key={module.id} module={module} viewMode={viewMode} />
              ))}
            </div>
          ) : (
              ...
              <CardContent>
                <div className="flex flex-col items-center space-y-4 max-w-md mx-auto text-center">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-xl font-semibold text-gray-900">No modules match your criteria</h3>
