  ...
  return (
    <div className="flex flex-col items-center px-4 pb-24">
      {data && data.length > 0 ? (
        data.map((course, id) => (
          <div
            className="card bg-[#141d2b] w-full max-w-md shadow-lg mb-4 rounded-2xl overflow-hidden hover:shadow-2xl transition-shadow"
            key={id}
          >
            ...
            <div className="card-body p-6">
              ...
              {/* Action Button */}
              <button className="w-full mt-4 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors">
                View Course
              </button>
            </div>
          </div>
